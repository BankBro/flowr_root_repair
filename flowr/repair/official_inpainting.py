"""Stable exact-mask adapter for FLOWR.ROOT fragment inpainting."""
...
def fixed_first_index_map(fixed_mask: np.ndarray | torch.Tensor) -> np.ndarray:
    """Map official fixed-first output slots back to reference ligand indices."""
...
def build_exact_fragment_prior(
    ...
    """Call the official prior builder with an exact frozen fragment mask."""
